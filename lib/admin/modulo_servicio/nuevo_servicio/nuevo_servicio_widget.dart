...
import 'nuevo_servicio_model.dart';
export 'nuevo_servicio_model.dart';

class NuevoServicioWidget extends StatefulWidget {
  const NuevoServicioWidget({Key? key}) : super(key: key);

  @override
  _NuevoServicioWidgetState createState() => _NuevoServicioWidgetState();
}

class _NuevoServicioWidgetState extends State<NuevoServicioWidget> {
  late NuevoServicioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NuevoServicioModel());
                        ...
                        child: StreamBuilder<List<UsersRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FlutterFlowDropDown<String>(
                              ...
                              hintText: 'Seleccione el Trabajador',
                              icon: Icon(
                        ...
                        onPressed: () async {
                          await ServiciosRecord.collection
                              ...
                              .set(createServiciosRecordData(
                                trabajador: _model.dpdTrabajadorServicioValue,
                                ...
                                nombreServicio:
                                    _model.txtNombreServicioController.text,
                              ));
                          await showDialog(
                            context: context,
