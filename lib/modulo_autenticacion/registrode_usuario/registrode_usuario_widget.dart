...
import 'registrode_usuario_model.dart';
export 'registrode_usuario_model.dart';

class RegistrodeUsuarioWidget extends StatefulWidget {
  const RegistrodeUsuarioWidget({Key? key}) : super(key: key);

  @override
  _RegistrodeUsuarioWidgetState createState() =>
      _RegistrodeUsuarioWidgetState();
}

class _RegistrodeUsuarioWidgetState extends State<RegistrodeUsuarioWidget>
    with TickerProviderStateMixin {
  late RegistrodeUsuarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrodeUsuarioModel());
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 12.0, 0.0, 24.0),
                                        child: Text(
                                          'Llena los siguientes espacios con la información solicitada.',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
                                              .override(
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            focusNode:
                                                _model.txtContrasennaFocusNode,
                                            autofocus: true,
                                            autofillHints: [
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  ...
                                                  content: Text(
                                                      'Se ha enviado un correo a su bandeja de entrada. Ingrese al link y confirme su correo para poder entrar a la aplicación.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
